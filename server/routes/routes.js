...
router.post('/syncUser', async (req, res) => {
  ...
  try {
    ...
    const result = await client.query('INSERT INTO users (id, email, firstName, lastName) VALUES ($1, $2, $3, $4) RETURNING *',
...
router.get('/getUsers', async (req, res) => {
  try {
    ...
    client.release();
    res.status(200).json({data: users, message: "", total: users.length});
