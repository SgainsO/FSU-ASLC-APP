...
const createElm = (e, t, o, n) => {
 ...
 if (null != t) {
  const o = Array.from(t.childNodes).find((e => e["s-cr"])), n = Array.from(e.childNodes);
  for (const e of o ? n.reverse() : n) null != e["s-sh"] && (t.insertBefore(e, null != o ? o : null), 
 ...
 (BUILD.vdomAttribute || BUILD.reflect) && (BUILD.slot && "slot" === a && !useNativeShadowDom ? BUILD.experimentalSlotFixes && e.$name$ !== t.$name$ && (t.$elm$["s-sn"] = t.$name$ || "", 
 relocateToHostRoot(t.$elm$.parentElement)) : updateElement(e, t, isSvgMode)), BUILD.updatable && null !== s && null !== l ? ((e, t, o, n, s = !1) => {
 ...
 (BUILD.scoped || BUILD.shadowDom) && (scopeId = i["s-sc"]), useNativeShadowDom = supportsShadow, 
 BUILD.slotRelocation && (contentRef = i["s-cr"], checkSlotFallbackVisibility = !1), 
...
const callRender = (e, t, o, n) => {
 ...
 })), s.length > 0 && (f && (d.textContent += SLOT_FB_CSS), BUILD.invisiblePrehydration && (BUILD.hydratedClass || BUILD.hydratedAttribute) && (d.textContent += s + "{visibility:hidden}.hydrated{visibility:inherit}"), 
 d.innerHTML.length)) {
