...
const createElm = (e, t, a, o) => {
 ...
 if (null != t) {
  const a = Array.from(t.childNodes).find((e => e["s-cr"])), o = Array.from(e.childNodes);
  for (const e of a ? o.reverse() : o) null != e["s-sh"] && (t.insertBefore(e, null != a ? a : null), 
  e["s-sh"] = void 0, checkSlotRelocate = !0);
 }
 plt.$flags$ &= -2;
 ...
 (appData.BUILD.vdomAttribute || appData.BUILD.reflect) && (appData.BUILD.slot && "slot" === l && !useNativeShadowDom ? appData.BUILD.experimentalSlotFixes && e.$name$ !== t.$name$ && (t.$elm$["s-sn"] = t.$name$ || "", 
 relocateToHostRoot(t.$elm$.parentElement)) : updateElement(e, t, isSvgMode)), appData.BUILD.updatable && null !== s && null !== n ? ((e, t, a, o, s = !1) => {
 ...
 (appData.BUILD.scoped || appData.BUILD.shadowDom) && (scopeId = i["s-sc"]), useNativeShadowDom = exports.supportsShadow && 0 != (1 & p.$flags$), 
 appData.BUILD.slotRelocation && (contentRef = i["s-cr"], checkSlotFallbackVisibility = !1), 
...
exports.addHostEventListeners = addHostEventListeners, exports.bootstrapLazy = (e, t = {}) => {
 ...
 })), s.length > 0 && (m && (p.textContent += SLOT_FB_CSS), appData.BUILD.invisiblePrehydration && (appData.BUILD.hydratedClass || appData.BUILD.hydratedAttribute) && (p.textContent += s + "{visibility:hidden}.hydrated{visibility:inherit}"), 
 p.innerHTML.length)) {
